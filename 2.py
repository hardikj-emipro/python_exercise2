...
class Scrapping(Manufacturing):
    ...
    def __init__(self, raw_material_product, finished_product, raw_material_ratio_quantity):
        Manufacturing.__init__(self, raw_material_product, finished_product, raw_material_ratio_quantity)
...
while True:
    ...
    print('5. Enter Finished product scrap quantity')
    print('6. Enter Raw Material product scrap quantity')
    print('7. Exit')
